...
// Prompts users for information about their logo,
// uses the information to creates a logo,
// and then generates a logo.svg file containing the contents of the logo
function cli() {
    inquirer
        .prompt([
            {
