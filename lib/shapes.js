// Classes used to generate the shape and text of the logo
// The parent class is Shape.
// The child (Circle, Triangle Square) classes inherit Shape properties and methods.
// Each child class then renders their own custom svg file content for the logo using the render() method.
class Shape {
